...
public class BlinkTeleportUtil {
    ...
    public static void teleport(
        ...
        // TODO implement this
        /*
        VehiclePreTeleportEvent prevent = new VehiclePreTeleportEvent(
                driver, vehicle, vehicle.getPassengers(), destination,
                (has(driver, "require_saddle")),
                has(driver, "require_tamed"),
                has(driver, "require_adult"),
                has(driver, "teleport." + vehicle.getType().name().toLowerCase()),
                true,
                has(driver, "match_vehicle_teleports"),
                has(driver, "disabled_world_from." + vehicle.getWorld().getName()),
                has(driver, "disabled_world." + destination.getWorld().getName())
        );
         */
